...
// +kubebuilder:rbac:groups=device.anankix.io,resources=physicaldevices,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=device.anankix.io,resources=physicaldevices/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=device.anankix.io,resources=physicaldevices/finalizers,verbs=update
...
func (r *PhysicalDeviceReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&devicev1alpha1.PhysicalDevice{}).
		Complete(r)
}
